    ...
    <div className="min-h-screen bg-white px-6 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">
          Got a question, feedback, or just want to say hi? We&rsquo;d love to hear
          from you.
        </p>
        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              id="name"
              name="name"
              className="mt-1 block w-full rounded-md border border-gray-300 px-4 py-2 text-gray-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
              required
            />
          </div>
